# -*- coding: utf-8 -*-
"""Repair page flow-state modes and main-line all_pass."""
...
def detect_repair_mode(wip):
    """
    Detect ui mode: repair_dido, repair_r_only, main_line.
    """
    names = [
        wip.get("GROUP_NAME"),
...
def is_di_do_ri_ro_wip_node(node: str) -> bool:
    """True if WIP node is on DI/DO/RI/RO rework path."""
...
def main_line_all_pass_for_sn(conn, sn: str) -> bool:
    """Same rule as Repair flow-state field all_pass."""
    from repair_module.core.routing import get_route_list
