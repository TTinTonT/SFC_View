# Unit tests for online_test.queue (port of tests/test_l10_online_test_queue.py).

import unittest

from online_test import queue as q


class OnlineTestQueueTest(unittest.TestCase):
    def setUp(self):
